...
import com.teragrep.aer_01.fakes.SourceableFake;
...
public final class PluginConfigurationTest {
    ...
    void testPluginConfigurationFromFile() {
        ...
        Assertions
                .assertEquals(
                        "com.teragrep.aer_01.plugin.DefaultPluginFactory", js.asJsonObject().getJsonArray("resourceIds").getJsonObject(0).getString("pluginFactoryClass")
                );
    }
