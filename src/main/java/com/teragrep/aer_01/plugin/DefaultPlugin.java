...
public final class DefaultPlugin implements Plugin {
    ...
    public List<SyslogMessage> syslogMessage(final ParsedEvent parsedEvent) {
        ...
        final SDElement sdPartition = new SDElement("aer_01_partition@48577")
        ...
        final SDElement sdEvent = new SDElement("aer_01_event@48577")
        ...
        final SDElement sdComponentInfo = new SDElement("aer_01@48577")
        ...
        final SyslogMessage syslogMessage = new SyslogMessage()
                ...
                .withTimestamp(
                        !parsedEvent.enqueuedTimeUtc().isStub() ? enqueuedTime.toInstant().toEpochMilli() : Instant
                                .now()
                                .toEpochMilli()
                )
        ...
        return Collections.singletonList(syslogMessage);
    }
